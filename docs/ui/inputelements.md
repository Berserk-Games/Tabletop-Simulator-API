...
Remember you can also use the [Id attribute](/ui/attributes#general-attributes) to identify which UI element triggered the function.
...
interactable |  | [<span class="tag boo"></span>](/ui/attributes#attribute-types) | `true`
colors |  | [<span class="tag xmlcb"></span>](/ui/attributes#attribute-types) | `#FFFFFF|#FFFFFF|#C8C8C8|rgba(0.78,0.78,0.78,0.5)`
...
caretWidth |  | float | `1`
caretColor |  | [<span class="tag xmlco"></span>](/ui/attributes#attribute-types) | `#323232`
selectionColor |  | [<span class="tag xmlco"></span>](/ui/attributes#attribute-types) | `rgba(0.65,0.8,1,0.75)`
readOnly |  | [<span class="tag boo"></span>](/ui/attributes#attribute-types) | false
textColor |  | [<span class="tag xmlco"></span>](/ui/attributes#attribute-types) | `#323232`
...
interactable |  | [<span class="tag boo"></span>](/ui/attributes#attribute-types) | `true`
colors |  | [<span class="tag xmlcb"></span>](/ui/attributes#attribute-types) | `#FFFFFF|#FFFFFF|#C8C8C8|rgba(0.78,0.78,0.78,0.5)`
textShadow |  | [<span class="tag xmlco"></span>](/ui/attributes#attribute-types) | *(none)*
textOutline |  | [<span class="tag xmlco"></span>](/ui/attributes#attribute-types) | *(none)*
...
icon |  | string | *(none)*
iconWidth |  | float |
iconColor |  | [<span class="tag xmlco"></span>](/ui/attributes#attribute-types) |
...
interactable |  | [<span class="tag boo"></span>](/ui/attributes#attribute-types) | `true`
textColor |  | [<span class="tag xmlco"></span>](/ui/attributes#attribute-types) | `#000000`
colors |  | [<span class="tag xmlcb"></span>](/ui/attributes#attribute-types) | `#FFFFFF|#FFFFFF|#C8C8C8|rgba(0.78,0.78,0.78,0.5)`
isOn | If the toggle is "on" or not. Is the value sent to onValueChanged's function. | [<span class="tag boo"></span>](/ui/attributes#attribute-types) | false
...
Attribute Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | Description&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | Type&nbsp;/&nbsp;Options&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | Default&nbsp;Value&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
-- | -- | -- | --
allowSwitchOff | If this is set to true, then the user may clear their selection from within the ToggleGroup by clicking on the selected Toggle. | [<span class="tag boo"></span>](/ui/attributes#attribute-types) | `false`
toggleBackgroundImage | Sets the default background image to use for nested Toggle elements. | string |
toggleBackgroundColor |  | [<span class="tag xmlco"></span>](/ui/attributes#attribute-types) | `#FFFFFF`
toggleSelectedImage | Sets the default image to use for selected (checked) nested Toggle elements. | string |
toggleSelectedColor |  | [<span class="tag xmlco"></span>](/ui/attributes#attribute-types) | `#FFFFFF`
...
wholeNumbers |  | [<span class="tag boo"></span>](/ui/attributes#attribute-types) | false
direction |  | <ul><li>LeftToRight</li><li>RightToLeft</li><li>TopToBottom</li><li>BottomToTop</li></ul> | `LeftToRight`
backgroundColor |  | [<span class="tag xmlco"></span>](/ui/attributes#attribute-types) | *(none)*
fillColor |  | [<span class="tag xmlco"></span>](/ui/attributes#attribute-types) | *(none)*
fillImage |  | string |
handleColor |  | [<span class="tag xmlco"></span>](/ui/attributes#attribute-types) | *(none)*
handleImage |  | string |
...
interactable |  | [<span class="tag boo"></span>](/ui/attributes#attribute-types) | `true`
textColor |  | [<span class="tag xmlco"></span>](/ui/attributes#attribute-types) | `#000000`
itemBackgroundColors |  | [<span class="tag xmlcb"></span>](/ui/attributes#attribute-types) | #FFFFFF|#FFFFFF|#C8C8C8|rgba(0.78,0.78,0.78,0.5)
itemTextColor |  | [<span class="tag xmlco"></span>](/ui/attributes#attribute-types) | `#000000`
checkColor |  | [<span class="tag xmlco"></span>](/ui/attributes#attribute-types) | `#000000`
checkImage |  | string |
arrowColor |  | [<span class="tag xmlco"></span>](/ui/attributes#attribute-types) | `#000000`
arrowImage |  | string |
dropdownBackgroundColor |  | [<span class="tag xmlco"></span>](/ui/attributes#attribute-types) | `#000000`
dropdownBackgroundImage |  | string |
scrollbarColors |  | [<span class="tag xmlcb"></span>](/ui/attributes#attribute-types) |
